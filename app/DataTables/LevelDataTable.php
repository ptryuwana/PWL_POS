...
class LevelDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            return '<a href="/PWL_POS/public/level/edit/' . $row->level_id . '" class="btn btn-secondary">Edit</a>
                    <a href="/PWL_POS/public/level/delete/' . $row->level_id . '" class="btn btn-danger">Delete</a>';
        })
        ->setRowId('id');
    }
